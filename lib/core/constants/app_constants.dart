...
TextStyle textStyle3Secondary = TextStyle(
    fontSize: 16,
    fontFamily: 'Lato',
    fontWeight: FontWeight.bold,
    color: secondaryColor.withOpacity(0.6)
);
TextStyle textStyle4Secondary = TextStyle(
    fontSize: 14,
    fontFamily: 'Lato',
    fontWeight: FontWeight.bold,
...
const white18TextStyle = TextStyle(
    fontFamily: 'Lato-Regular',
    fontSize: 18,
    fontWeight: FontWeight.w500,
    color: whiteColor
);
var drawerItemTileTextStyle = TextStyle(
    fontFamily: 'Lato-Regular',
    fontSize: 16,
    fontWeight: FontWeight.w500,
    color: secondaryColor.withOpacity(0.8)
);
const drawerItemTileRedTextStyle = TextStyle(
    fontFamily: 'Lato-Regular',
    fontSize: 16,
    fontWeight: FontWeight.w500,
    color: redColor
